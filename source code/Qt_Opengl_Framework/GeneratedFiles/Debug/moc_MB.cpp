...
void Ui_MyMessageBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Ui_MyMessageBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Ui_MyMessageBox::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Ui_MyMessageBox.data,
    qt_meta_data_Ui_MyMessageBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
