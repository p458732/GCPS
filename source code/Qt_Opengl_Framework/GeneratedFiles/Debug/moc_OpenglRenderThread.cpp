...
void OpenglRenderThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OpenglRenderThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OpenglRenderThread::*)();
...
QT_INIT_METAOBJECT const QMetaObject OpenglRenderThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_OpenglRenderThread.data,
    qt_meta_data_OpenglRenderThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
